     ...
     //   List<Osxy> kub2 = new List<Osxy>();
      ...
      //  Single matrix_x = 0;
        ...
        private void drow_figures()
        {
            ...
            if (radioButton2.Checked)
            {
                ...
                for (int i1 = 0; i1 < osxy_rhombus.Count - 1; i1++)
                {
                    ...
                    //   gl.Begin(OpenGL.GL_POLYGON);
                    //   gl.LineWidth(4);
                    gl.Color(0f, 0f, 0f);     // красный цвет
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            /*foreach (Osxy figures in kub1)
            {
                //figures.x 
                double l =Math.Sin(degrees(90));
                   figures.y =Convert.ToSingle( Math.Cos(degrees(10)) *figures.x -Math.Sin(degrees(10)) *figures.z);
                   figures.z = Convert.ToSingle(Math.Sin(degrees(10)) * figures.x + Math.Cos(degrees(10)) * figures.z);
                   

                //  figures.z += 0;
            }

            foreach (Osxy figures in kub2)
            {
                figures.y = Convert.ToSingle(Math.Cos(10 * 0.0175) * figures.x - Math.Sin(10 * 0.0175) * figures.z);
                figures.z = Convert.ToSingle(Math.Sin(10 * 0.0175) * figures.x + Math.Cos(10 * 0.0175) * figures.z);
